...
public class Test05 extends TestCore {
    ...
    public void testMembership() {
        ...
        requiredClass(tc);
        mbrList = requiredVariable(tc, "mbrList", Modifier.PRIVATE, "jsjf.UnorderedListADT<cscmatch.Member>");
        ...
        try {
            ...
            LinkedList<Object> m = (LinkedList<Object>) mbrList.get(mbrshp);
            if (m == null) {
                fail("constructor failed to initialize mbrList");
            }
            if (!(m instanceof LinkedUnorderedList)) {
                fail("mbrList is not an jsjf.LinkedUnorderedList");
            }
            if (m.size() != 0) {
            ...
            try {
                ...
                if (e2.getClass().equals(illegalArgumentExceptionClass.getClazz())) {
                    fail("addMember is using the wrong UnorderedListADT add method");
                }
                unexpected(e2);
            }
