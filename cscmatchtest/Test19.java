...
public class Test19 extends TestCore {
    ...
    public void runTests() {
        ...
        enforceStep1Restrictions(false);
        summarizeTests();
    }
    ...
    public void testMembership() {
        ...
        Method getTopic;
        Method getLevel;
        boolean shallowTestPassed = true;
        ...
        try {
            ...
            if (e2.getClass().equals(fileNotFoundExceptionClass.getClazz())) {
                ...
                shallowTestPassed = false;
                errorMessage("TestData.csc may have been created using an earlier version of one of your classes: "
                        + e2.getMessage());
            } else {
                unexpected(e2);
            }
        }
        if (shallowTestPassed) {
            pass("Data loaded and printed successfully but was not verified by this test");
        }
    }
}
